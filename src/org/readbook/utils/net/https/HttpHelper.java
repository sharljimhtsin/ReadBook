package org.readbook.utils.net.https;
...
public class HttpHelper {
	...
	private String getUserAgent() {
		...
		// sb.append("osversion/").append(Constants.UserAgent.osversion).append(" ");
		...
		// sb.append("longitude/").append(Constants.UserAgent.longitude).append(" ");
		// sb.append("resolution/").append(Constants.UserAgent.resolution).append(" ");
		return sb.toString();
	}
			...
			((AbstractHttpClient) this.httpClient)
					.addResponseInterceptor(new HttpResponseInterceptor() {
						public void process(final HttpResponse response,
							...
							if (encheader != null) {
								HeaderElement[] codecs = encheader
										.getElements();
	...
	private void setHttpsUtil() {
		myX509TrustManager xtm = new myX509TrustManager();
		myHostnameVerifier hnv = new myHostnameVerifier();
		SSLContext sslContext = null;
		try {
			sslContext = SSLContext.getInstance("SSL"); // 或TLS
	...
	public String httpUpload(String u, Map<String, String> params,
			String filePath) {
